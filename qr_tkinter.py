...
#################images#################
heading = PhotoImage(file=r'D:\Python_Dev2\New_project\images\qrcodemonkey.png')
create_img = PhotoImage(file=r'D:\Python_Dev2\New_project\images\create.png')
reset_img = PhotoImage(file=r'D:\Python_Dev2\New_project\images\reset.png')
################################################################
...
intro = Label(frame,text="Created By Mayank !",bg="#f2f2f2",font="sans-serif 9 ")
